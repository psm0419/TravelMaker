...
<body>
	...
	<div class="QnADetailContainer mt-4">
		...
		<!-- 댓글 입력 -->
		<form action="${pageContext.request.contextPath}/QnADetail/${postList.postId}/comment" method="post">
		...
		<hr>
		<a href="/QnABoard" class="btn btn-secondary">목록</a>
	</div>
...
<script>
    document.getElementById('likeBtn').addEventListener('click', function() {
        fetch('${pageContext.request.contextPath}/QnA/${postList.userId}/like', { method: 'POST' })
